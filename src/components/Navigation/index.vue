...
<template>
        <div class="w-full fixed z-20 top-0 left-0 right-0 bg-transparent">
            <nav class="lg:bg-white shadow-2xl lg:shadow-none lg:max-w-[1380px] w-[94%] mx-auto m-4 p-5 rounded-xl">
                <div class="flex items-center justify-between px-4 h-16">
                    ...
                    <div class="items-center space-x-12 hidden lg:flex">
                        <RouterLink
                            ...
                            :key="menu.name"
                            :class="{
                                'text-[#27e08f]': isActive(menu.path),
                ...
                <transition name="fade-slide">
                    ...
                    @click="toggleMenu"
                    >
                        <div class="bg-white text-black w-full h-full flex flex-col space-y-6 overflow-y-auto relative"
                        @click.stop>
